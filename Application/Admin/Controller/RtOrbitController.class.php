...
class RtOrbitController extends AuthController{
	
	public function index(){
        $this->assign("navsys", array("GPS", "BDS"));
        $this->assign("fields", array("SAT", "Status", "FRE", "Datum", "IODE", "D0-A", "D0-C", "D0-R", "D1-A", "D1-C", "D1-R", "C0", "C1", "C2"));
        $redis = new Redis();
        if($redis->exists('sat')){
            $b = $redis->get('sat');
            $rs = unserialize($b);
